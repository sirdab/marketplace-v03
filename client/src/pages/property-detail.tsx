      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-4">{t('property.notFoundDesc')}</p>
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <div className="max-w-7xl mx-auto px-3 md:px-6 lg:px-8 py-4 md:py-6">
          <Link
            href="/properties"
            className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground mb-4 md:mb-6 text-sm md:text-base"
          >
            ...
            <div className="lg:col-span-2 space-y-4 md:space-y-6">
              ...
              <div>
                <p className="font-bold text-xl md:text-2xl lg:text-3xl mb-1">
                  {formattedPrice}
                  <span className="text-muted-foreground font-normal text-sm md:text-base ms-2">
                    {priceLabel}
                  </span>
                </p>
                <h1
                ...
                <div className="flex flex-wrap items-center gap-2 md:gap-4 text-muted-foreground text-sm md:text-base">
                  ...
                  {property.forSale === true && (
                    <Badge
                      variant="outline"
                      className="text-xs md:text-sm border-green-500 text-green-600 dark:text-green-400"
                    >
                  ...
                  {property.forDailyRent === true && (
                    <Badge
                      variant="outline"
                      className="text-xs md:text-sm border-blue-500 text-blue-600 dark:text-blue-400"
                    >
              ...
              <div>
                <h2 className="text-base md:text-xl font-semibold mb-2 md:mb-3">
                      ...
                      <CardContent className="space-y-4">
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          ...
                          <div>
                            ...
                            <p className="font-medium">{t(`categories.${categoryKey}`)}</p>
                          </div>
                          <div>

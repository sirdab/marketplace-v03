            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {ads.map((ad) => (
                <Link key={ad.id} href={`/ads/${ad.id}`}>
                  <Card className="overflow-hidden hover-elevate cursor-pointer h-full" data-testid={`card-ad-${ad.id}`}>
                    ...
                    <CardContent className="p-4">
                      <h3 className="font-semibold mb-2 line-clamp-2" data-testid={`text-ad-title-${ad.id}`}>
                        {ad.title}
                      </h3>

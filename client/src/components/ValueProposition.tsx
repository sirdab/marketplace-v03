        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-8 lg:gap-10">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-sm md:text-lg font-semibold mb-1 md:mb-2 line-clamp-2">
                {t(`value.${feature.titleKey}`)}
              </h3>
              <p className="text-xs md:text-sm text-muted-foreground max-w-xs mx-auto line-clamp-3">

        ...
        <CardContent className="p-3 md:p-4">
          ...
          <div className="flex items-center gap-2 flex-wrap text-muted-foreground text-sm mb-2">
            ...
            {property.forSale === true && (
              <Badge
                variant="outline"
                className="text-xs px-1.5 py-0 h-5 font-normal border-green-500 text-green-600 dark:text-green-400"
              >
            ...
            {property.forDailyRent === true && (
              <Badge
                variant="outline"
                className="text-xs px-1.5 py-0 h-5 font-normal border-blue-500 text-blue-600 dark:text-blue-400"
              >
          ...
          <h3
            className="font-medium text-sm md:text-base line-clamp-1 mb-1"
